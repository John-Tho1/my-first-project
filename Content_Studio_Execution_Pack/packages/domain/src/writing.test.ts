...
describe('FIX-T09: 묶음의 파생본 AI 참조는 같은 파생본의 variant run', () => {
  ...
  function build(threadsRun: string) {
    const tables = {
      ...
      claim_confirmations: [], claims: [], claim_sources: [], usage_ledger: [], assets: [], variant_assets: [], transcription_jobs: [], transcripts: [], audit_events: [], channel_accounts: [], distribution_plans: [], distribution_items: [], approvals: [], jobs: [], job_events: [], execute_commands: [], send_intents: [], publications: [],
    } as unknown as BundleTables;
    return buildBundle({
