...
describe('묶음 호환: 0005 이전 묶음', () => {
  ...
  function oldBundle(opts: { dropTableFiles: boolean; migrations: string[] }) {
    const tables = {
      ...
      transcription_jobs: [],
      transcripts: [],
      audit_events: [], channel_accounts: [], distribution_plans: [], distribution_items: [], approvals: [], jobs: [], job_events: [], execute_commands: [], send_intents: [], publications: [], mock_scenarios: [],
...
describe('FIX-T09: 묶음의 파생본 AI 참조는 같은 파생본의 variant run', () => {
  ...
  function build(threadsRun: string) {
    const tables = {
      ...
      claim_confirmations: [], claims: [], claim_sources: [], usage_ledger: [], assets: [], variant_assets: [], transcription_jobs: [], transcripts: [], audit_events: [], channel_accounts: [], distribution_plans: [], distribution_items: [], approvals: [], jobs: [], job_events: [], execute_commands: [], send_intents: [], publications: [], mock_scenarios: [],
    } as unknown as BundleTables;
    return buildBundle({
